  ...
  intro.setOptions({
    steps: [
      { 
        ...
        element: "#map",
        intro: "Vous disposez ici d'une carte montrant l'ensemble des localisations d'un individu anonyme que nous nommerons Monsieur Martin.<br /> C'est une carte de type <i>heatmap</i>, ou \"carte de chaleur\".<br />Les points proches sont superposés, et plus il y a de points superposés, plus la couleur s'approche du bleu."
      },{
        element: "#map",
        intro: "Un point très bleu est donc une zone dans laquelle M. Martin s'est rendu très souvent. C'est ce que l'on appelle un <i>hot-spot</i>, ou \"point chaud \"."
      },{
        element: "#map",
        ...
        element: "#daydensity",
        intro: "Vous pouvez par exemple sélectionner les heures correspondant à la nuit pour trouver les endroits où M. Martin passe ses nuits, et donc, sans doute, son domicile."
      },{
        element: "#dayfreq",
        ...
        element: "#dayfreq",
        intro: "Vous pouvez par exemple observer la différence entre la localisation de M. Martin en semaine et en week-end pour faire ressortir la différence de fréquentation des lieux de travail et des lieux de loisir."
      },{
        element: "#monthfreq",
        intro: "Comme le graphique précédent, mais celui-ci informe sur la fréquence mensuelle. Vous pouvez ainsi différencier les mois d'été, qui peuvent montrer les vacances de M. Martin, des mois usuels plus liés à son espace quotidien."
      },{
        element: "#yearPlot",
        ...
        element: "#calendarPlot",
        intro: "Cela permet par exemple de comprendre quand M. Martin a effectué un voyage particulier, ou encore d'avoir une idée de la fréquentation sur l'année de lieux secondaires."
      },{
        element: "#automaticAnalysis",
        intro: "Dans ce paneau, vous pouvez executer (en cochant l'icône \"Lancer les analyses\") une analyse automatique qui vise à deviner où l'utilisateur est domicilié et où il travaille.<br /><hr /> Pour cela, on effectue une opération de classification des points, en observant les lieux où l'utilisateur se trouve le plus souvent. On isole ensuite parmi ces lieux l'endroit où l'utilisateur est le plus souvent pendant la journée de travail,  en jours de semaines, pour trouver le lieu de travail. En effectuant la même opération pour les heures de nuit, on trouve le domicile probable.<br />Grâce à une opération nommée \"géocodage inverse\", on peut alors déduire l'adresse de ces deux \"hot-spots\"."
      },{
        intro: "C'est la fin de cette visite guidée, vous êtes maintenant invités à explorer le jeu de données qui vous est ici présenté, en essayant de comprendre le déroulement des journées et semaines de l'utilisateur, M. Martin, qui vous est ainsi livré."
      },{
